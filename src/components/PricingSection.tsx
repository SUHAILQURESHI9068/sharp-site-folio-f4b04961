...
const packages = [
  {
    ...
    price: 25000,
    priceDisplay: "₹25,000",
    description: "Best for local service providers and professional portfolios",
    features: [
      "5 Premium Pages",
  ...
  },
  {
    ...
    price: 65000,
    priceDisplay: "₹65,000",
    description: "Best for emerging brands and small e-commerce stores",
    features: [
      "Up to 15 Pages",
      "Basic CMS for Easy Updates",
      "Supabase Backend Integration",
      "SEO Optimization",
      "Social Media Integration",
      "3 Months Technical Maintenance",
  ...
  },
  {
    ...
    description: "Best for Startups and complex SaaS applications",
    features: [
